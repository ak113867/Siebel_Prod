			...
			SiebelAppFacade.VF_Intelligence_Search_FBB_PR = (function () {
				...
				function TriggerNBNAddress() {
					...
					if (service) {
						...
						 if (sLongitude != "" && sLongitude != null && sLongitude != "undefined")
								sIntCallInputs.SetProperty("longitude",sLongitude);
							if (sLatitude != "" && sLatitude != null && sLatitude != "undefined")
								sIntCallInputs.SetProperty("latitude",sLatitude);
							if (sDPID != "" && sDPID != null && sDPID != "undefined")
							{
								
								let frstname = sDPID[0];
								if( frstname === "G"){
									sIntCallInputs.SetProperty("GnafPid",sDPID);								}
							}
						//	SBBAU-added for R1.1.hotfix COT  Unit Addr-End
