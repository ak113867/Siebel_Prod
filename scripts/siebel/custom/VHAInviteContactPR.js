     ...
     function () {
      ...
      SiebelAppFacade.VHAInviteContactPR = (function () {
       ...
       VHAInviteContactPR.prototype.ShowUI = function () {
		...
		// Hari Y added to hide marketing fields 
		let valuesToHide = ['productoffers', 'newsletter', 'loyally','oneappweb']; 
 
		$('.vha-img-channel-checkbox').filter(function() {
			return valuesToHide.includes($(this).find('input').val());
		}).hide();
		// check kogan
