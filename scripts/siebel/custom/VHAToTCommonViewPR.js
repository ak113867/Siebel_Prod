...
if (typeof SiebelAppFacade.VHAToTCommonViewPR === "undefined") {
    ...
    define("siebel/custom/VHAToTCommonViewPR", ["siebel/viewpr", "siebel/custom/bootstrap.min"], function () {
        SiebelAppFacade.VHAToTCommonViewPR = (function () {
			...
			var sSBSwitch = VHAAppUtilities.GetPickListValues("", "[List Of Values.Type]='VHA_RELEASE_SWITCH' AND [List Of Values.Name]='SPEED_BOOST_CR' AND [List Of Values.Active]='Y'", "")[0];
			var MspEligible = "N";
			var MspDiscount = "0";
			var MspOrdSeq = "";
			var MspPropSblPrdType = "";
			var sSBApply = "N";
			var sSBProduct = "";
			var sSBSpeed = "0 Mbps";
			var SBWarn = "";  //Santosh: MAS CR 3.0
			var SBPop = "";  //Santosh: MAS CR 3.0
			var SBUIMessage = "";  //Santosh: MAS CR 3.0
	  ...
	  $('#vhatotcreditcard').off("click").on("click", function(){
                                ...
                                if (Outs.GetProperty("CreditCheckStatus") == "APPROVE") {
                                    ...
                                    if (sRSProceed == "Y") {
                                        ...
                                        if (o.NextStep) {
                                            ...
                                            //NASReviewSummary();
                                            $("#NSAEmailNotification").html("");
                                            SiebelAppFacade.VHATOTNSAOrderSummaryPR_PDF.createPDF(o.pdfInp,MspEligible,MspDiscount,MspPropSblPrdType,MspOrdSeq);
                                        }
                                        return o.NextStep;
                                    } else {
                                        return false;
		 ...
		 (custType == "New") ? getTilesData(app.plansForNewUser, searchCondition) : getTilesData(app.plansForOldUser, searchCondition);  	
			...
			'</div>';*/
                ...
                var b = "";
				if (sRelSwitch == "Y"){
					b = '<div class="vha-cart-sum"><div class="row mt-5">\
				...
				<div class="vha-cart-sum-chd">\
					<div class="row">\
						<div class="row vha-tot-pt pb-3 col-md-10">\
							...
							<div class="col-md-10 ml-5">\
								...
								<div class="row vha-tot-SBplan VFDisplayNone">\
									<div class="vha-tot-cartitemw"></div>\
									<div class="h5 vha-tot-cartval"></div>\
								</div>\
							</div>\
						</div>\
					...
					<div class="row vha-tot-discount pb-3">\
						...
						<div class="col-md-12 ml-5 vha-tot-discount-chd">\
							...
							<div class="row cart-discount-msp VFDisplayNone">\
            ...
            VHAToTCommonViewPR.addCartItems = function (lineitems) {
                switch (lineitems.type) {
                    ...
                    case "cart-discount-bundle":
                        ...
                        VHAToTCommonViewPR.calcIndCost();
                        break;
					case "cart-discount-msp":
						if (lineitems.dollar > 0 ) {
							$("." + lineitems.subType + " .vha-tot-cartval").text("-$" + Number(lineitems.dollar).toFixed(2));
							if ($(".cart-discount-msp").hasClass("VFDisplayNone") == true) $(".cart-discount-msp").removeClass("VFDisplayNone");
							VHAToTCommonViewPR.calcIndCost();
                        }
						
						break;
					case "vha-tot-SBplan":
						if (lineitems.dollar != "" &&  lineitems.dollar != null) {
							$("." + lineitems.subType + " .vha-tot-cartitemw").text(lineitems.dollar);
							$("." + lineitems.subType + " .vha-tot-cartval").text(lineitems.value+" Mbps");
							if ($(".vha-tot-SBplan").hasClass("VFDisplayNone") == true) $(".vha-tot-SBplan").removeClass("VFDisplayNone");
						}						
						break;
            ...
            function resetCartItems() {
                ...
                $("#prodNameInCart").text("").text("Cart is empty");
                $("#planIdInCart").text("");
                $(".vha-tot-headerplan .vha-tot-cartitemw,.vha-tot-SBplan .vha-tot-cartval,.vha-tot-SBplan .vha-tot-cartitemw").text("");
                $(
                    ".vha-tot-headerplan .vha-tot-cartval,.cart-roaming-addons .vha-tot-cartval,.cart-data-addons .vha-tot-cartval,.cart-idd-addons .vha-tot-cartval,.cart-discount-loyalty .vha-tot-cartval,.cart-discount-credit .vha-tot-cartval,.cart-discount-bundle .vha-tot-cartval,.cart-discount-msp .vha-tot-cartval,.cart-discount-restrict .vha-tot-cartval"
                ).text("$0.00");
                ...
                if ($(".vha-tot-addons .VFDisplayNone").length == 6) $(".cart-roaming-addons,.cart-data-addons,.cart-idd-addons,.cart-discount-restrict,.cart-discount-msp").addClass("VFDisplayNone");
                    ...
                    for (var a = 0; a < l; a++) {
                        $($($("button.vha-addtocartbtn"))[a])
                            ...
                            .on("click", function () {
                                $("#maskoverlay").styleShow();
                                totsleep(30).then(() => {
									$(".vha-tot-SBplan .vha-tot-cartval,.vha-tot-SBplan .vha-tot-cartitemw").text("");
                                    $("#prodNameInCart")
                                        .text("")
                ...
                switch (data.evt) {
                    ...
                    case "SET_ADDTOCART_EVT":
                        ...
                        if (o.propArray["Error Code"] != "" || o.propArray["Error Message"] != "") {
							...
							if (sRelSwitch == "Y"){
								MspEligible = o.propArray["MSPEligible"];
								MspDiscount = o.propArray["MSPDiscount"];
								MspOrdSeq = o.propArray["MSPServiceSequence"];
								MspPropSblPrdType = o.propArray["ProposSblProdType"];
							}
							VHAToTCommonViewPR.addCartItems(selectionObj);
							sSBApply = o.propArray["SBApply"];
							sSBProduct = o.propArray["SBProduct"];
							sSBSpeed = o.propArray["SBProductSpeed"];
							SBWarn = o.propArray["SBWarn"];    //Santosh: MAS CR 3.0
							SBUIMessage = o.propArray["SBUIMessage"];   //Santosh: MAS CR 3.0
							SBPop = o.propArray["SBPop"];    //Santosh: MAS CR 3.0
							console.log("sSBApply: "+sSBApply+" and sSBProduct: "+sSBProduct+" and sSBSpeed: "+sSBSpeed + " and SBWarn: "+SBWarn+" and SBUIMessage: "+SBUIMessage+" and SBPop: "+SBPop);
							//Start -> Santosh: MAS CR 3.0 
							if(SBWarn == "Y")
							{
								alert(SBUIMessage);
								return false;
							...
							{
								var sConfirm = confirm(SBUIMessage);
								if(sConfirm)
								{
									return true;
								}
                            ...
                            refreshTOTheader();
                            var sBillAId = SiebelApp.S_App.GetActiveBusObj().GetBusCompByName("VHA TOT Generic BC").GetFieldValue("Billing Account Id");
                            if (sBillAId != "" && totFlow == "Postpay" && sRelSwitch == "N") SiebelAppFacade.VHAAccessoriesPR.initializeBundleSave();
							if (sRelSwitch == "Y" && MspEligible == "Y" ) SiebelAppFacade.VHAAccessoriesPR.initializeMSPDiscount(MspDiscount);
							if (sSBSwitch == "Y" && sSBApply == "Y" && sSBProduct != "" && sSBProduct != null) SiebelAppFacade.VHAAccessoriesPR.initializeSpeedBoost(sSBProduct,sSBSpeed);
