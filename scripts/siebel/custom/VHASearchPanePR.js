    ...
    define("siebel/custom/VHASearchPanePR", ["siebel/searchpanerenderer"], function() {
        SiebelAppFacade.VHASearchPanePR = (function() {
                ...
                VHASearchPanePR.prototype.ShowUI = function() {
						...
						// Migration Status
						$('#showtext').before('<div id="vha-migration-status" style="font-size: 2rem; color: red;"></div>');
                    },
                            ...
                            $("#" + i.Get("GetPlaceholder")).on("click", '[id*="CDIcon"]', {
                                ...
                                if (!$(this).hasClass("siebui-search-pane-inline-close") && !$(this).hasClass("siebui-search-pane-inline-open")) {
                                    ...
                                    for (h = 0; h < l.length; h++) {
                                        c = l[h].split(":SEP:");
										// Migration Status
										if(l[h].split(':')[0] === 'Legacy Migration Status'){
											if (sBCName === "VF MSISDN"  || sBCName == "VF Billing Account" || sBCName === "Account"|| sBCName === "Contact" ){
												if(l[h].split(':')[2] === 'In Progress')
													$('#vha-migration-status').text('Migration InProgress');
												else
													$('#vha-migration-status').text('');
											}
											else{
												$('#vha-migration-status').text('');
											}
