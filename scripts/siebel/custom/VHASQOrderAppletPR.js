								...
								if (sFIBCONInterimSwitch == "ON"){
									...
									if(sTBUIFLow == "" || sTBUIFLow == null || sTBUIFLow == "Additional Connect"){
										...
										if (sFibreConnectServiceable == "Yes" && (sTransferTypeSwitch == "Y" || sTransferTypeSwitch == "" || sTransferTypeSwitch == null)) {
											...
											$('[name=' + this_t.GetPM().Get("GetControls")["Customer Bundled Flag"].GetInputName() + ']').parent().show();    //Monit: 2.2 Speed boost CR
											...
											$("#Customer_Bundled_Flag_Label_" + this_t.GetPM().Get("GetId")).parent().show();  //Monit: 2.2 Speed boost CR
											...
											$('[name=' + this_t.GetPM().Get("GetControls")["Customer Bundled Flag"].GetInputName() + ']').parent().hide();  //Monit: 2.2 Speed boost CR
											...
											$('[name=' + this_t.GetPM().Get("GetControls")["VHA NBN SLA Plan"].GetInputName() + ']').parent().hide();
											$("#VHA_NBN_SLA_Plan_Label_" + this_t.GetPM().Get("GetId")).parent().hide();
											$("#Customer_Bundled_Flag_Label_" + this_t.GetPM().Get("GetId")).parent().hide();    //Monit: 2.2 Speed boost CR
										...
										$("#Customer_Bundled_Flag_Label_" + this_t.GetPM().Get("GetId")).parent().parent().hide();    //Monit: 2.2 Speed boost CR
										$("#Rate_Plan_Label_" + this_t.GetPM().Get("GetId")).parent().parent().hide();
										$('[name=' + this_t.GetPM().Get("GetControls")["VHA NBN SLA Plan"].GetInputName() + ']').parent().hide();
											$("#VHA_NBN_SLA_Plan_Label_" + this_t.GetPM().Get("GetId")).parent().hide();
										$('[name=' + this_t.GetPM().Get("GetControls")["Select Rate Plan"].GetInputName() + ']').parent().hide();
