if (typeof SiebelAppFacade.VHANSA3StepUpgradePR_PDF === "undefined") {
    ...
    define("siebel/custom/VHANSA3StepUpgradePR_PDF", ["siebel/phyrenderer", "siebel/custom/pdfLibrary/jspdf.min"], function () {
        SiebelAppFacade.VHANSA3StepUpgradePR_PDF = (function () {
            function VHANSA3StepUpgradePR_PDF(pm) {
                SiebelAppFacade.VHANSA3StepUpgradePR_PDF.superclass.constructor.apply(this, arguments);
            }
            SiebelJS.Extend(VHANSA3StepUpgradePR_PDF, SiebelAppFacade.PhysicalRenderer);
            VHANSA3StepUpgradePR_PDF.prototype.Init = function () {
                SiebelAppFacade.VHANSA3StepUpgradePR_PDF.superclass.Init.apply(this, arguments);
            };
			var mspSwitch = "N";
            var metaData = {
                logo: {
            ...
            VHANSA3StepUpgradePR_PDF.prototype.ShowUI = function () {
                SiebelAppFacade.VHANSA3StepUpgradePR_PDF.superclass.ShowUI.apply(this, arguments);
                var sTransType = "";
				mspSwitch = VHAAppUtilities.GetPickListValues("", "[List Of Values.Type]='VHA_RELEASE_SWITCH' AND [List Of Values.Name]='RELEASE_ONE_DOT_TWO' AND [List Of Values.Active]='Y'", "")[0];
            };
            ...
            VHANSA3StepUpgradePR_PDF.prototype.BindData = function (bRefresh) {
                SiebelAppFacade.VHANSA3StepUpgradePR_PDF.superclass.BindData.apply(this, arguments);
            };
            VHANSA3StepUpgradePR_PDF.prototype.BindEvents = function () {
                SiebelAppFacade.VHANSA3StepUpgradePR_PDF.superclass.BindEvents.apply(this, arguments);
            };
            VHANSA3StepUpgradePR_PDF.createPDF = function (resultset, sTransType, TerminateValueCart, pegaoffDataGlob, pegaflag, dis_samid_flag) {
                ...
                SiebelApp.S_App.SetProfileAttr("VFDeliveryAddr", sDeliveryAddress);
                ...
                var sMSPHeaderDetail = ServiceOrder.GetProperty("MSPHeaderDetail");//Added by soumalya for R2.0 PDF changes for MSP
                ...
                doc.addImage(loadImage(), "PNG", x + 150, y - 2, metaData.logo.width, metaData.logo.height);
                ...
                initialYvalue = y;
				//change variable initialization part based on switch for R2.0 MSP PDF changes
				var dataSet;
                if(mspSwitch == "Y")
					dataSet = [[{
                            label: "",
                ...
                if (SerOrdCnt > 0) {
                    ...
                    if (PSDPP == "Y") {
                        ...
                        if (DPP == "Y") {
                            ...
                            Modifiedrows = emptyrows;
                        doc.autoTable(col, Modifiedrows, {
                            startY: (number = y += metaData.lineSpace.vertical2),
                            margin: {
                                left: x
                            },
                            tableWidth: 190,
                    ...
                    if (GPP == "Y") {
                        ...
                        if (AccessoryPP == "Y") {
                            var col = ["Accessories", "", "", "", ""]
                            doc.autoTable(col, Accessoryrows, {
                                startY: (number = y),
                                margin: {
                                    left: x
                                },
                        ...
                        if (RolloverPP == "Y") {
                            ...
                            doc.autoTable(col, Rolloverrows, {
                                startY: (number = y),
                                margin: {
                                    left: x
                                },
                    ...
                    if (Disc == "Y") {
                        var col;
						if(mspSwitch == "Y")
							col = ["Offers & Credits", "Offers & Credits($)", "", "", "Term"];
						else
							col = ["Discounts & Offers", "Discounts & Offers($)", "", "", "Term"];
                        var emptyrows = [];
                        FurtherRow = [{
                                value1: "",
                                value2: "",
                        ...
                        if (PrevDisc == "Y") {
                            ...
                            var col;
							if(mspSwitch == "Y")
								col = ["Previous Offers & Credits", "", "", "", ""];
							else
								col = ["Previous Discounts & Offers", "", "", "", ""];
                            doc.autoTable(col, Prevrows, {
                                startY: (number = y),
                                margin: {
                                    left: x
                                },
                ...
                doc.autoTable({
                    ...
                    body: [["The terms and conditions of my plan are available at www.vodafone.com.au/sfoa. I agree and accept the information in this form.\nAuthorised by:"]]
                })
                y = doc.lastAutoTable.finalY;
                doc.addImage(loadQRImage(), "PNG", x + 150, y, 35, 35);
                ...
                y = y + 5;
                doc.addImage(loadArrowImage(), "PNG", x + 1, y - 2, 8, 8);
                doc.setTextColor(metaData.textColor.black);
                doc.setFontStyle(metaData.textStyle.bold);
                doc.setFontSize(metaData.fontSize.seven);
            ...
            VHANSA3StepUpgradePR_PDF.prototype.EndLife = function () {
                SiebelAppFacade.VHANSA3StepUpgradePR_PDF.superclass.EndLife.apply(this, arguments);
            };
